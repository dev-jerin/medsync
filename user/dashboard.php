            ...
            <div class="page-content">
                ...
                <section id="records-page" class="page">
                    <div class="content-panel">
                        ...
                        <p class="text-secondary">A chronological timeline of your health history, including hospital admissions, lab results, and prescriptions.</p>

                        <div id="records-timeline-container" class="timeline-container">
                            </div>

                        <div id="records-loading-state" style="display: none; text-align: center; padding: 2rem;">
                            <p>Loading your medical history...</p>
                        </div>

                        <div id="records-empty-state" class="empty-state" style="display: none;">
                            <i class="fas fa-file-excel"></i>
                            <h3>No Medical Records Found</h3>
                            <p>Your health records from hospital visits will appear here once they are added by our staff.</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="summaries-page" class="page">
                    <div class="content-panel">
                        ...
                        <div id="summaries-empty-state" class="empty-state" style="display: none;">
                            <i class="fas fa-file-excel"></i>
                            <h3>No Discharge Summaries Found</h3>
                            <p>Summaries from your past hospital stays will appear here once available.</p>
                        </div>
                    </div>
                </section>
                            ...
                            <form id="personal-info-form" class="profile-form">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="profile-username" value="<?php echo htmlspecialchars($user_details['username'] ?? 'N/A'); ?>" readonly>
                                    </div>
                                    <div class="form-group">
